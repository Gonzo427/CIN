...
function my_theme_enqueue_styles() {
    wp_enqueue_style( 'cin-child', get_template_directory_uri() . '/style.css' );

    wp_enqueue_style('cin-styles', get_stylesheet_directory_uri() . '/css/styles.css' , array(  )); 
    wp_enqueue_style('cin-animations', get_stylesheet_directory_uri() . '/css/animations.css' , array(  )); 
